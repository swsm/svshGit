...
<body>
    <center>
        <div class="easyui-layout" style="width:830px;height:580px; border: 1px rgb(202, 196, 196) solid;
            border-radius: 5px;">
            ...
            <div data-options="region:'south',border:false" style="height:210px">
                <fieldset style="border-radius: 3px; height: 180px;">
                    <legend>表达式</legend>
                            ...
                            <tr>
                             ...
                             <tr>
							    ...
							    <td colspan="6"><input type="text" name="cron" style="width: 100%;" 
							    		value="<%=request.getParameter("value")%>" id="cron"/></td>
							    <td><input type="hidden" value="反解析到UI " id="btnFan" onclick="btnFan()"/></td>
						    </tr>
                        </tbody>
                    </table>
                </fieldset>
