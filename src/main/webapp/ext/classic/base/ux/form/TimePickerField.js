...
Ext.define('Ext.ux.form.TimePickerField', {
	  ...
	  */
	  ...
	  initComponent: function() {
		  ...
		  me.secondsSpinner.ownerCt=this;
	  ...
	  onSpinnerChange: function() {
		  ...
		  var rawtime = this.getRawValue();
		  var array = [rawtime.h,rawtime.m,rawtime.s];
		  var maxArray = [23,59,59];
